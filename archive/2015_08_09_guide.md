Wow, this guide is long. Why not skip it? <a href="mailto:george.j.london@gmail.com?subject=Help%20me%20deploy%20Django&amp;body=Gee,%20I'm%20already%20writing%20this%20email.%20I%20guess%20I%20might%20as%20well%20hire%20you.">I'm available to freelance.</a>
...
**By the end of this guide, you should have a simple but stable actually deployed
...
**UPDATE: Opscode has made some breaking changes to some cookbooks this project depends on and as a result the Chef scripts no longer work out of the box. I think the principles and general method in this guide are sound, but you probably shouldn't try following these instructions unless you're comfortable reading and writing Chef scripts. Hopefully I'll have time to fix everything soon.**

[Here is the Github repo for this post](https://github.com/rogueleaderr/definitive_guide_to_django_deployment).
...
Leave a helpful comment (or even better submit a pull request to the Github repo.) The full text of this post is available in the repo and I'll update this guide as appropriate.**
...
files which are not tracked by your VCS. You can you AWS access and secret keys on your [AWS security page](https://portal.aws.amazon.com/gp/aws/securityCredentials).
...
version, meaning we have the longest period before it&rsquo;s officially
...
directive on the command line but the defaults are sensible for now.
...
**Nginx**: Our
  ...
  whether they should be passed to Gunicorn, served as a static file,
served as a &ldquo;Gunicorn is down&rdquo; error page, or even blocked (e.g. to prevent denial-of-service
...
try to figure out how to install that resource. If a configuration file has been modified, Chef will fix(/brutally overwrite) it. Recipes are
...
Just use them. Also apparently baked into Django 1.7.
...
**Thanks to [Kate Heddleston](https://twitter.com/heddle317), [Noah Kantrowitz](https://twitter.com/kantrn), and [Eric Holscher](https://twitter.com/ericholscher) for reviewing drafts of this guide.**

###Get this far? [LinerNotes is hiring](http://www.linernotes.com/about/jobs/).
...
</my></process-name-and-long-character-string></app_name></app_name></app_name></app_name></app_name></sha1_hash_of_release></app_name></app_name></app_name></app_name></app_name></app_name></your></your></your></your></your></your></project_name></project_name></project_name></your></your></your></your></your></your></your></your>